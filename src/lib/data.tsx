...
export const dailyLifeData = [
  {
    ...
    title: "দৈনন্দিন জীবন",
    description:"শিক্ষার্থীরা একটি সু-সংগঠিত দৈনিক রুটিন অনুসরণ করে যেখানে নামাজ, পড়াশোনা, অতিরিক্ত কার্যক্রম এবং ব্যক্তিগত উন্নয়নের জন্য সময় বরাদ্দ থাকে। এটি শৃঙ্খলা ও আধ্যাত্মিক সমৃদ্ধি বাড়ায়।",
