...
export const ourHeritageData = [
  {
    ...
    description:
      "আত-তাফিজ ইন্টারন্যাশনাল মাদরাসা শুরু থেকেই সেরা মানের ইসলামিক শিক্ষাদানের জন্য প্রতিশ্রুতিবদ্ধ। আমাদের গ্র্যাজুয়েটরা ধর্মীয় এবং আধুনিক জ্ঞানের ক্ষেত্রে দক্ষতা অর্জন করে, যা তাদের এ জীবন এবং পরকালে সফল করে তোলে।",
  },
  {
    icon: (
      <svg
